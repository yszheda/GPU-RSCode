...
#define EXP_TABLE_SIZE 509

gf gflog[LOG_TABLE_SIZE];
gf gfexp[EXP_TABLE_SIZE];
...
{
	int i;
	fprintf(fp, "__const__ uint8_t gfexp[%d] = {", EXP_TABLE_SIZE);
...
{
	int i;
	fprintf(fp, "__const__ uint8_t gflog[%d] = {", LOG_TABLE_SIZE);
