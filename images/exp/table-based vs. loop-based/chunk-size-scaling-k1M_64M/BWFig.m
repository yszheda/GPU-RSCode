...
plot(chunkSizeScaling(1,2:end), chunkSizeScaling(6,2:end), 'Color', 'k', 'DisplayName', 'k=8,n=10(Loop-based)');
plot(chunkSizeScaling(1,2:end), chunkSizeScaling(7,2:end), 'Color', 'c', 'DisplayName', 'k=16,n=18(Loop-based)');
hold off
legend('k=4,n=6 (Table-based)', 'k=8,n=10 (Table-based)', 'k=16,n=18 (Table-based)', 'k=4,n=6 (Loop-based)', 'k=8,n=10 (Loop-based)', 'k=16,n=18 (Loop-based)', 'Location', 'Best');
